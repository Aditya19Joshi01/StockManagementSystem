...
![High-level Use Case Diagram](link_to_diagram)

### User Management
![User Management Diagram](link_to_diagram)

### Update Stock Information
![Update Stock Information Diagram](link_to_diagram)

### View Stock, Sales, Order Report
![View Stock, Sales, Order Report Diagram](link_to_diagram)

### Order Processing
![Order Processing Diagram](link_to_diagram)

## Class Diagrams
### User Management
![User Management Class Diagram](link_to_diagram)

### Creating, Deleting, Updating an Order
![Creating, Deleting, Updating an Order Class Diagram](link_to_diagram)

### View Stock, Sales, and Order Reports
![View Stock, Sales, and Order Reports Class Diagram](link_to_diagram)

### Order Processing
![Order Processing Class Diagram](link_to_diagram)

## Activity Diagrams
### User Management
![User Management Activity Diagram](link_to_diagram)

### CUD Operations on Categories and Products
![CUD Operations on Categories and Products Activity Diagram](link_to_diagram)

### Order Processing
![Order Processing Activity Diagram](link_to_diagram)

### Displaying Reports
![Displaying Reports Activity Diagram](link_to_diagram)

## State Diagrams
### User Management
![User Management State Diagram](link_to_diagram)

### CUD Operations on Product/Category
![CUD Operations on Product/Category State Diagram](link_to_diagram)

### Displaying Reports
![Displaying Reports State Diagram](link_to_diagram)

### Order Processing
![Order Processing State Diagram](link_to_diagram)
...
## Sample Images of the Implementation
### Home Page
![Home Page](link_to_image)

### User Signup
![User Signup](link_to_image)

### User Login and Details Update
![User Login and Details Update](link_to_image)

### Adding Categories as the Admin
![Adding Categories](link_to_image)

### New Category Displayed
![New Category Displayed](link_to_image)

### Adding Products and Placing an Order
![Adding Products](link_to_image)

### Payment
![Payment](link_to_image)

### Order Placed After Payment
![Order Placed](link_to_image)

### Additional Functionalities
#### Viewing All Registered Users as Admin
![Viewing All Registered Users](link_to_image)
